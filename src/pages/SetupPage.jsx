...
const SetupPage = () => {
  return (
    <main className="bg-[#f1f5f9] text-[#312e81] min-h-screen p-8">
      <div className="container mx-auto flex flex-col md:flex-row gap-8">
        ...
        <section className="md:w-1/2">
          ...
          <p className="text-lg mb-4">
            Setting up a printer for the first time can indeed be daunting.
            Here's a simplified step-by-step guide to help streamline the
            process.
          </p>
      ...
      {/* ------------------- */}
      {/* Second Section */}
      <div className="container mx-auto flex flex-col md:flex-row gap-8 mt-8 border-b-4 border-[#312e81] p-6">
        <section className="md:w-1/2">
          <h2 className="text-3xl font-bold mb-4">
