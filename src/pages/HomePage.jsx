...
function HomePage() {
  return (
    <>
      <main className="bg-[#f1f5f9] text-[#312e81] min-h-screen">
        <div className="container mx-auto flex flex-col md:flex-row items-start gap-8 p-10">
          <section className="md:w-1/2">
            ...
            <ul className="space-y-4">
              <li className="flex items-center gap-3">
                <CheckBoxIcon className="text-[#312e81]" />
          ...
          <section className="md:w-1/2 flex justify-center md:justify-end">
            <img
              src="https://img.freepik.com/premium-photo/printer-scanner-laser-copy-machine-supplies-office_34936-1678.jpg?w=826"
              alt="Printer Scanner"
